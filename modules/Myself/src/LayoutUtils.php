...
class LayoutUtils
{
    ...
    public static function showLiveEditableText(
        ...
        if (!self::isEditAllowed()) {
            ...
            echo '<div class="myself-show-if-editmode ' . $class . '" data-id="' . $storable . '" data-property-name="' . $propertyName . '" data-array-key="' . $arrayKey . '" contenteditable="true" data-multiline="' . (int)$multiline . '">' . $content . '</div>';
        }
    }
}