...
tinymce.PluginManager.add('pagemyself', function (editor, url) {
  ...
  editor.ui.registry.addMenuButton('pagemyself-templates', {
    ...
    fetch: async function fetch(callback) {
    ...
    return {
      ...
      'card': {
        ...
        'fields': [Object.assign(new FramelixFormFieldColor(), {
          ...
          required: true,
          defaultValue: 'none',
          options: [['none', '__pagemyself_editor_templates_type_card_animation_none__'], ['flip', '__pagemyself_editor_templates_type_card_animation_flip__'], ['slidein', '__pagemyself_editor_templates_type_card_animation_slidein__']]
        })]
      },
      'icon': {
        'html': ``,
