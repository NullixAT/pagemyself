...
This is a [modified version](https://github.com/brainfoolong/php-image-resize) of the [original](https://github.com/brainfoolong/php-image-resize) to fit the needs for PageMyself. 
