    ...
    PageMyselfPageEditor.iframeHtml.find('.page-block').each(function () {
      ...
      const options = $(`
        <div class="pageeditor-block-options" data-block-id="${blockId}">
          ...
          <button class="framelix-button framelix-button-small sort-block-down" data-icon-left="south" title="__pagemyself_pageblock_sort_down__"></button>    
          <button class="framelix-button framelix-button-small sort-block-up" data-icon-left="north" title="__pagemyself_pageblock_sort_up__"></button>          
        </div>
      `)
